...
const lastHeaderCeil = headerRow.querySelectorAll("th")[headerRow.querySelectorAll("th").length - 1];
...
bodyRowsArr.forEach((bodyRow)=>{
    ...
    const lastBodyCeil = bodyRow.querySelectorAll("td")[bodyRow.querySelectorAll("td").length - 1];
...
const lastFooterCeil = footerRow.querySelectorAll("th")[footerRow.querySelectorAll("th").length - 1];
